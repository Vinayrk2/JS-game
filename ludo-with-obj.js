...
function startTheGame(){
    ...
    // document.getElementById('path21').appendChild(document.getElementById('rt2'));
   	// overallPath[70].appendChild(document.getElementById('bt2'));
   	// overallPath[70].appendChild(document.getElementById('bt3'));
   	// overallPath[70].appendChild(document.getElementById('bt1'));
   	// overallPath[65].appendChild(document.getElementById('bt4'));
   	overallPath[40].appendChild(document.getElementById('yt4'));
   	// winner[0] = 0;
   	// winners = 0;
	// gamers[0].showObject;
	roll = true;
...
function initpath(){
    ...
    overallPath[overallPath.length] = document.getElementById("indicate");
	}
...
console.log(winner[0])
    ...
    document.getElementById("number").style.backgroundColor = gamers[count].color;
